  ...
  return (
    <div className="bg-white transform rotate-3 hover:rotate-0 transition-all duration-300 shadow-xl hover:shadow rounded-xl overflow-hidden">
      <div className="px-8 py-5 leading-relaxed text-xl text-gray-800">
        ...
        asperiores cupiditate quibusdam sint quisquam commodi optio quod autem
        cumque fugit error cum, sapiente provident eveniet, quia, ab ad et
        possimus.
      </div>
        ...
        <div className="flex items-center">
          <div className="flex-shrink-0 mr-3">
            <img
              ...
              src="https://media-exp1.licdn.com/dms/image/C4E03AQHnsno00Cb8eA/profile-displayphoto-shrink_200_200/0/1618214201724?e=1639612800&v=beta&t=ElvUQ9dVNVoQvF1pFa5z9bZSwqIphkAmQDqalw6zTuA"
              alt="Chaerul"
            />
          </div>
          <div className="text-white">Chaerul Marwan</div>
        </div>
        <a
          href="#"
